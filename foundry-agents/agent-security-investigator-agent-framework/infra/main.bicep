...
@description('Region for the Foundry account, project, and model deployments. Defaults to the general resource location.')
...
@description('Exact name of the AI Foundry project to reuse or create. Supplied by AZURE_AI_PROJECT_NAME.')
